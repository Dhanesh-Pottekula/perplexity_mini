...
class StorageAgentPydanticModels:
    ...
    class TopicExtractionList(BaseModel):
        topics: List["StorageAgentPydanticModels.TopicExtractionItem"]



"""Personality Models - Enums."""
class OpenRouterChatModels(StrEnum):

    class OpenRouterChatModelTypes(StrEnum):
        """OpenRouter chat models available for personality configurations."""
